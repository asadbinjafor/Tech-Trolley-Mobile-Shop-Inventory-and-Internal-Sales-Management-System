...
export class PurchasesController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a CONFIRMED purchase, records the purchase items, and receives ' +
  ...
  @ApiOperation({
    ...
    description:
      ...
      'rollback). Supplier dues are still derived from payment rows and remain ' +
      'accurate.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiBadRequestResponse({
    description:
      'Validation error, purchase not confirmed, amount not positive, or the ' +
